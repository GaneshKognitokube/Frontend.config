                        ...
                        <div className="flex max-lg:flex-col items-center justify-between gap-y-10">
                            ...
                            <div className="lg:w-1/2 lg:pl-10">
                                <div className="text-content">
                                    ...
                                    <p className="body2 text-surface1 mt-6">Boosting the American Economy According to the US. Today, the tech sector is the second-largest and one of the fastest-growing industries powering the U.S. economy, with American tech companies growing their GDP contributions by 9.8% in 2023</p>
                                    <div className="more-infor xl:w-1/2 lg:w-2/3 sm:w-1/2 w-3/4 mt-6">
                                        ...
                                        <div className="flex items-center justify-between mt-3">
                                            ...
                                            <span className="body2 text-surface1">September, 2024</span>
                                        </div>
                                        <div className="flex items-center justify-between mt-3">
