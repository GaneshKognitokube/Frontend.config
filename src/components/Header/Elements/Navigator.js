...
export default function Navigator( { disableSubmenu, className } ) {
  console.log("disableSubmenu:", disableSubmenu)
  ...
  function renderMenu() {
    return menuData.map((item, index) => {
      ...
      if ( item.title === "About Us" || item.title == "Contact" )
      {
        return (
          <li
            className={`relative ${
              pathname.includes("/About Us/") || pathname === "Contact"
                ? "active"
                : ""
            }`}
            key={index}
          ...
          >
            ...
            <div className="dropdown-menu -wide flex">
              <div className="left w-3/4 pr-[15px]">
                <div className="service-cate heading6">IT Services</div>
                <ul className="grid grid-cols-3 gap-5 gap-y-2.5 mt-2">
                  {item.subMenu.slice(0, 5).map((i, index) => (
                    <li
                      key={index}
                ...
                <div className="service-cate heading6">BPO Services</div>
                <ul className="grid grid-cols-3 gap-5 gap-y-2.5 mt-2">
                  {item.subMenu.slice(5, 7).map((i, index) => (
                    <li
                      key={index}
                      className={`${pathname === i.to ? "active" : ""}`}
                    >
                      ...
                      >
                        <Image
                          className={`text-blue text-2xl flex-shrink-0`}
                          src={i.icon}
                          width={25}
                          height={25}
                        ></Image>
                ...
                <div className="content bg-linear rounded-lg p-6">
                  ...
                  <div className="more-infor mt-8">
                    <div className="mail flex items-center">
                      ...
                      <div className="caption1 pl-2">info@aspiretech.ltd</div>
                    </div>
                    <div className="call flex items-center mt-3">
                      ...
                      <div className="text-title pl-2">+91 81210 07343</div>
                    </div>
